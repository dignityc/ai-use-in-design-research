...
class DataPreprocessor:
    ...
    def preprocess_data(self, df):
        ...
        # 전처리된 데이터 저장
        output_path = os.path.join(os.path.dirname(self.data_path), '../../analysis_work/results', 'nlp_analysis', 'data', 'processed_abstracts.csv')
...
class NLPAnalysisWorkflow:
    ...
    def __init__(self, data_path=None):
        ...
        if data_path is None:
            self.data_path = os.path.join(self.base_dir, '../../source', 'Result_2.csv')
        else:
            self.data_path = data_path
            
        self.output_dir = os.path.join(self.base_dir, '../results', 'nlp_analysis')
