...
def create_self_contained_dashboard():
    ...
    data_dir = os.path.join(base_dir, 'results', 'semantic_network_analysis', 'interactive', 'data')
...
<body>
    ...
    # 출력 파일 저장
    output_file = os.path.join(base_dir, 'results', 'semantic_network_analysis', 'interactive', 'self_contained_english_dashboard.html')
