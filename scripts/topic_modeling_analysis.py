...
class TopicModelingWorkflow:
    ...
    def __init__(self, data_path=None):
        ...
        if data_path is None:
            # 기존 정규화 데이터 사용
            self.data_path = os.path.join(self.base_dir, 'output', 'nlp_analysis_improved', 'data', 'normalized_data.csv')
        else:
            self.data_path = data_path
        
        self.output_dir = os.path.join(self.base_dir, 'output', 'topic_modeling_analysis')
